...
public class OrderRepositoryTest {
    ...
    void setUp() {
        ...
        Order order2 = new Order("7f9e11ab-b515-42f4-aebc-c3bf305f5070",
                products, 1708570000L, "Safira Sudrajat");
        orders.add(order2);

        Order order3 = new Order("e334efd0-9eff-4ca8-9487-8ea97edcb11a",
    ...
    void testFindByIdIfNotFound() {
        ...
        Order findResult = orderRepository.findById("aaaa");
